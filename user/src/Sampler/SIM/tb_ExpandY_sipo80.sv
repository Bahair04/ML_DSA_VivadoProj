...
initial begin
    ...
    st_64bit <= 64'h0000111111111111; @(posedge clk);
    st_64bit <= 64'h1111111122222222; @(posedge clk);

    st_64bit <= 64'h2222222222223333; @(posedge clk);
    st_64bit <= 64'h3333333333333333; @(posedge clk);
