...
assign coeff_rho_ExpandA = coeff_ExpandA;					// 输出扩展结果到外部端口
assign coeff_valid_rho_ExpandA = coeff_valid_ExpandA;		// 输出扩展有效信号到外部端口
...
assign coeff_rho_ExpandS = coeff_raw;						// 输出扩展结果到外部端口
assign coeff_valid_rho_ExpandS = coeff_valid_ExpandS;		// 输出扩展有效信号到外部端口
