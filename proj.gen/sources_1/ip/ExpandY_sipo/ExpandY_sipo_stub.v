...
// Command     : write_verilog -force -mode synth_stub -rename_top ExpandY_sipo -prefix
//               ExpandY_sipo_ ExpandA_sipo_stub.v
// Design      : ExpandA_sipo
...
module ExpandY_sipo(clk, srst, din, wr_en, rd_en, dout, full, empty, 
  rd_data_count)
/* synthesis syn_black_box black_box_pad_pin="clk,srst,din[63:0],wr_en,rd_en,dout[127:0],full,empty,rd_data_count[4:0]" */;
  input clk;
  input srst;
  input [63:0]din;
  input wr_en;
