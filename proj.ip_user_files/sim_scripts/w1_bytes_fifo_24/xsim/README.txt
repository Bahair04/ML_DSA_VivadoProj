...
#
# Generated by export_simulation on Fri Mar 27 18:44:55 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './w1_bytes_fifo_24.sh' script.

./w1_bytes_fifo_24.sh -reset_run
...
./w1_bytes_fifo_24.sh -noclean_files

For more information on the script, please type './w1_bytes_fifo_24.sh -help'.
