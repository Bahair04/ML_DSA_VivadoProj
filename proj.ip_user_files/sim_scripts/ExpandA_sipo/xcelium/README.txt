...
#
# Generated by export_simulation on Wed Jan 28 10:05:36 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './ExpandA_sipo.sh' script.

./ExpandA_sipo.sh -reset_run
...
./ExpandA_sipo.sh -noclean_files

For more information on the script, please type './ExpandA_sipo.sh -help'.
